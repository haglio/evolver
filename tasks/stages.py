...
STAGES: tuple[Stage, ...] = (
    ...
    Stage("withdrawn", "Taken Back",
          "Delete every copy this library holds of a clip Origenerator has taken back -- the inbox copy, the 1_sorted copy, the upscale and, down the Genau lane, the delivered loop -- read off that app's own gallery, which is the only place the withdrawal is recorded",
          (0x00, 0x00, 0x6C)),
