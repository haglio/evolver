    ...
    def test_writes_a_sidecar_per_clip_folding_variants(self):
        with workspace_temp_dir() as root:
            ...
            with override_config(
                ...
                original = _touch(non_ai / "winston" / "2 done" / "Mya-Luanna-lA0JUsAd.mp4")
                variant = _touch(
                    non_ai / "winston" / "3_good_to_go" / "processed"
                    / "Mya-Luanna-lA0JUsAd_3_apf2_iris2.mp4"
                )
                other = _touch(non_ai / "winston" / "0 unsorted" / "Juelz-Ventura-1.mp4")
                ...
                self.assertEqual(
                    ...
                    metadata / "2D" / "non_AI" / "winston" / "2 done" / "Mya-Luanna-lA0JUsAd.json",
                )
    ...
    def test_does_not_tag_a_name_neighbour_as_a_clip(self):
        ...
        with workspace_temp_dir() as root:
            ...
            with override_config(
                ...
                clip = _touch(non_ai / "winston" / "1 clips" / "Kim Lee - POV Scene 2.mp4")
                upscaled = _touch(
                    non_ai / "winston" / "3_good_to_go" / "processed"
                    / "Kim Lee - POV Scene 2_apo8_iris2.mp4"
                )
                neighbour = _touch(
                    non_ai / "winston" / "0 unsorted"
                    / "Kim Lee - POV Scene 2 (2009) Enhanced.mp4"
                )
