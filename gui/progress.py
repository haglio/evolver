...
STAGES = [
    ...
    ("upscale_non_ai", "Upscale non-AI",  "Supervise one detached Topaz encode of a 2D/non_AI video (apo-8 60fps + iris-2 toward 4K), started only while the tray toggle is on and the AI queue is drained"),
